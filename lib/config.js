...
Config.prototype.descriptions = function() {
  return {
    ...
    uploadTmpBinary:"should we upload to a tmp path on one packages host instead of the final tar path? sets tmp path in _npmOpperationalInternal. Use if tar-follower is replicating packages.",
  }
};
